  ...
  return (
    <section id="contact" className="py-16 px-6 md:px-12 max-w-6xl mx-auto">
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20 rounded-3xl p-12 text-center"
      >
        ...
        <div className="flex justify-center gap-4 mb-10">
          <a
            href="https://github.com/ritesh-negii"
            target="_blank"
            rel="noopener noreferrer"
            className="w-14 h-14 rounded-full bg-white flex items-center justify-center hover:scale-110 hover:shadow-[0_10px_30px_rgba(74,144,226,0.4)] transition-all duration-300"
            aria-label="GitHub"
          >
          ...
          <a
            href="https://www.linkedin.com/in/ritesh-negi-86ba72315/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-14 h-14 rounded-full bg-[#0077b5] flex items-center justify-center hover:scale-110 hover:shadow-[0_10px_30px_rgba(0,119,181,0.4)] transition-all duration-300"
            aria-label="LinkedIn"
          >
